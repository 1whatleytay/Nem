...
namespace Nem {
    void PPUPaletteMemory::setClearColor(Byte value) {
        clearColor = value;
        clearColorListener(value);
    }
    void PPUPaletteMemory::setBackgroundPalette(int index, PPUPalette palette) {
        background[index] = palette;
        backgroundListener(index, palette);
    }
    void PPUPaletteMemory::setSpritePalette(int index, PPUPalette palette) {
        sprite[index] = palette;
        spriteListener(index, palette);
    }

    Byte PPUPaletteMemory::getClearColor() {
        return clearColor;
    }
    PPUPalette PPUPaletteMemory::getBackgroundPalette(int index) {
        return background[index];
    }
    PPUPalette PPUPaletteMemory::getSpritePalette(int index) {
        return sprite[index];
    }
